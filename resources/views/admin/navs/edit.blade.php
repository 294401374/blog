            ...
            <table class="add_tab">
                <tbody>                    
                     <tr>
                        ...
                        <td>
                            <input type="text" name="navs_name" value="{{$field->navs_name}}">
                            <input type="text" class="sm" name="navs_alias" value="{{$field->navs_alias}}">
                            <span><i class="fa fa-exclamation-circle yellow"></i>导航名称必填</span>
                        </td>
                    </tr>
                     <tr>
                    ...
                    <tr>
                        <th>排序：</th>
                        <td>
                            <input type="text" class="sm" name="navs_order" value="{{$field->navs_order}}">
                        </td>
                    </tr>                   
                    <tr>
                        <th></th>
